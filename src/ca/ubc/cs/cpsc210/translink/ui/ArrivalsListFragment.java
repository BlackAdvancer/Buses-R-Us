...
public class ArrivalsListFragment extends ListFragment {
    ...
    private ArrayList<Arrival> getArrivalsForSelectedStop() {
        ...
        HttpArrivalDataProvider httpArrivalDataProvider = new HttpArrivalDataProvider(selectedStop);
        try {
            parseArrivals(selectedStop, httpArrivalDataProvider.dataSourceToString());
        }catch (Exception e){

        }

        return (ArrayList<Arrival>) selectedStop.getArrivals();
    }
